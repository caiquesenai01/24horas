...
--
-- Host: 127.0.0.1:3307
-- Tempo de geração: 14/11/2025 às 20:48
...
INSERT INTO `tarefa` (`id_tarefa`, `id_professor`, `id_sala`, `id_setor`, `nome_professor_tarefa`, `cargo_solicitante`, `sala_tarefa`, `descricao_tarefa`, `categoria_tarefa`, `status_tarefa`, `prioridade_tarefa`, `foto_tarefa`, `data_abertura_tarefa`, `data_ultima_atualizacao_tarefa`, `data_conclusao_tarefa`, `periodo`) VALUES
(8, 2, 20, NULL, 'Marcos', '', '20', 'casca', 'Manutenção', 'aberta', 'baixa', 'uploads/20211013_170549.jpg', '2025-11-14 22:16:07', NULL, NULL, 'Manha'),
(9, 2, 16, NULL, 'Daviss', '', '16', 'asdac', '', 'aberta', 'baixa', 'uploads/20210318_151458.jpg', '2025-11-14 22:34:44', NULL, NULL, 'Manha'),
(10, 2, 16, NULL, 'Daviss', '', '16', 'asdac', '', 'aberta', 'baixa', NULL, '2025-11-14 22:35:05', NULL, NULL, 'Manha'),
(14, 2, 19, NULL, 'MUNICIPIO DE ALAGOINHAS', 'professor', 'LAB_ACIONAMENTOS', 'asdasca', 'Manutenção', 'aberta', 'baixa', 'uploads/suporte_senai.sql', '2025-11-14 22:51:43', NULL, NULL, 'Manha'),
(15, 2, 22, NULL, 'ca', 'professor', 'LAB_PNEUMATICA', 'sdaca', 'Manutenção', 'aberta', 'alta', NULL, '2025-11-14 22:59:45', NULL, NULL, 'Manha');
...
--
ALTER TABLE `tarefa`
  MODIFY `id_tarefa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
